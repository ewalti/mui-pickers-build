(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prop-types'), require('react'), require('@material-ui/core/styles/createStyles'), require('@material-ui/core/styles/withStyles'), require('@material-ui/core/Toolbar'), require('@material-ui/core/Typography'), require('@material-ui/core/IconButton'), require('@material-ui/core/SvgIcon'), require('react-dom'), require('@material-ui/core/InputAdornment'), require('@material-ui/core/TextField'), require('@material-ui/core/Button'), require('@material-ui/core/Dialog'), require('@material-ui/core/DialogActions'), require('@material-ui/core/DialogContent'), require('@material-ui/core/styles'), require('@material-ui/core/Popover'), require('@material-ui/core/Paper'), require('@material-ui/core/styles/withTheme'), require('@material-ui/core/Tab'), require('@material-ui/core/Tabs')) :
    typeof define === 'function' && define.amd ? define(['exports', 'prop-types', 'react', '@material-ui/core/styles/createStyles', '@material-ui/core/styles/withStyles', '@material-ui/core/Toolbar', '@material-ui/core/Typography', '@material-ui/core/IconButton', '@material-ui/core/SvgIcon', 'react-dom', '@material-ui/core/InputAdornment', '@material-ui/core/TextField', '@material-ui/core/Button', '@material-ui/core/Dialog', '@material-ui/core/DialogActions', '@material-ui/core/DialogContent', '@material-ui/core/styles', '@material-ui/core/Popover', '@material-ui/core/Paper', '@material-ui/core/styles/withTheme', '@material-ui/core/Tab', '@material-ui/core/Tabs'], factory) :
    (global = global || self, factory(global['material-ui-pickers'] = {}, global.PropTypes, global.React, global['material-ui'].createStyles, global['material-ui'].withStyles, global['material-ui'].Toolbar, global['material-ui'].Typography, global['material-ui'].IconButton, global['material-ui'].SvgIcon, global.ReactDOM, global['material-ui'].InputAdornment, global['material-ui'].TextField, global['material-ui'].Button, global['material-ui'].Dialog, global['material-ui'].DialogActions, global['material-ui'].DialogContent, global['material-ui'].styles, global['material-ui'].Popover, global['material-ui'].Paper, global['material-ui'].withTheme, global['material-ui'].Tab, global['material-ui'].Tabs));
}(this, function (exports, PropTypes, React, createStyles, withStyles, Toolbar, Typography, IconButton, SvgIcon, reactDom, InputAdornment, TextField, Button, Dialog, DialogActions, DialogContent, styles, Popover, Paper, withTheme, Tab, Tabs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ModalDialog$1 = styles.withStyles(styles$9, {
    ...
    exports.DatePickerBase = DatePicker$1;
